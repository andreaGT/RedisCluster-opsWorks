...
default[:redis][:cluster_dir]       = '/etc/redis/cluster'
...
# Cluster
#
default[:redis][:clusterenable] = 'no'
default[:redis][:clustertimeout] = 5000

#
# Redis utility directory
#
default[:redis][:utility_dir] = '/usr/share/doc/redis-tools/examples/'
